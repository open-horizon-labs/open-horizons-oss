-- Drop and recreate get_endeavor_guardrails to add override_protocol and created_at
-- Previous migration created function without DROP, which failed because PostgreSQL
-- doesn't allow changing return type with CREATE OR REPLACE
