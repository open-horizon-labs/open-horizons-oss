---
name: ship
description: Quality gate from implementation to merge. 13-step pipeline with delivery verification and comment sweep.
...
2. Read `.oh/guardrails/` for active constraints
3. Identify the PR, branch, and issue being closed
4. Read the PR description and issue acceptance criteria
5. Check for CodeRabbit review comments on the PR

## The 13 Steps

### 1. /review
Check implementation against acceptance criteria and guardrails.

**Post findings as PR comment:**
```bash
gh pr comment <PR> --body "## Ship Step 1: Review
...
### 5. Merit assessment
Is this worth merging? Verdict: MERGE / MERGE WITH CAVEATS / ABANDON. **Post as PR comment.**

### 6. Resolve TODOs
Every TODO must be fixed, marked N/A with reasoning, or filed as follow-up.
